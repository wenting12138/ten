...
import com.wen.qa.dao.ProblemDao;
...
public class ProblemService {
	...
	public ResultService<PageResult<Problem>> newList(String label, Integer page, Integer size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		Page<Problem> page1 = problemDao.newList(label, pageable);
		List<Problem> problemList = page1.getContent();
		Long count = page1.getTotalElements();
		if (problemList == null || problemList.isEmpty()) {
			return new ResultService<>(false);
		}
		return new ResultService<>(true, 1, new PageResult<>(count, problemList));
	}
	public ResultService<PageResult<Problem>> hotlist(String label, Integer page, Integer size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		Page<Problem> page1 = problemDao.hotList(label, pageable);
		List<Problem> problemList = page1.getContent();
		Long count = page1.getTotalElements();
		if (problemList == null || problemList.isEmpty()) {
			return new ResultService<>(false);
	...
	public ResultService<PageResult<Problem>> waitlist(String label, Integer page, Integer size) {
		Pageable pageable = PageRequest.of(page - 1, size);
		Page<Problem> page1 = problemDao.waitList(label, pageable);
		List<Problem> problemList = page1.getContent();
		Long count = page1.getTotalElements();
		if (problemList == null || problemList.isEmpty()) {
			return new ResultService<>(false);
